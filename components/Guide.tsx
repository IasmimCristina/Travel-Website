...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24 xl:flex-col">

        <Image src={"/camp.svg"} alt='Acampamento' width={50} height={50} className='' />
        <p className="uppercase regular-18 -mt-1 text-yellow-90">Estamos aqui por você</p>

        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">

          <h2 className='bold-40 lg:bold-64 xl:max-w-[490px]'>Guiar você para o caminho fácil</h2>
          <p className='regular-16 text-gray-20 xl:max-w-[720px]'>
